    ...
    <main>
      ...
      <form id="settings-form" method="POST" action="<?php echo URLROOT; ?>/member/updateSettings" enctype="multipart/form-data">
        ...
        <div class="profile-picture">
            <img src="<?php echo URLROOT; ?>/assets/images/Member/<?php echo !empty($data['member']->image) ? $data['member']->image : 'default-placeholder.jpg'; ?>" alt="Profile Picture" id="profilePicture">
            <input 
                type="file" 
                name="image" 
