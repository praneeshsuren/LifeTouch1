  ...
  <body>
    ...
    <main>
      ...
      <div class="settings-container">
        ...
        <form id="settings-form" method="POST" action="<?php echo URLROOT; ?>/manager/updateSettings" enctype="multipart/form-data">
          <input type="hidden" name="user_id" value="<?php echo $data['manager']->manager_id; ?>">

          <div class="details">
              <!-- Profile Picture -->
              <div class="profile-picture">
                  <img src="<?php echo URLROOT; ?>/assets/images/Manager/<?php echo !empty($data['manager']->image) ? $data['manager']->image : 'default-placeholder.jpg'; ?>" alt="Profile Picture" id="profilePicture">
              ...
              <div class="user-details">
                  <p>
                      ...
                      <input type="text" id="manager-id" name="manager_id" value="<?php echo $data['manager']->manager_id; ?>" disabled>
                  </p>
                  <p>
                  ...
                  <p>
                      ...
                      <input type="text" id="first-name" name="first_name" value="<?php echo $data['manager']->first_name; ?>" disabled>
                  ...
                  <p>
                      ...
                      <input type="text" id="last-name" name="last_name" value="<?php echo $data['manager']->last_name; ?>" disabled>
                  ...
                  <p>
                      ...
                      <input type="email" id="email" name="email_address" value="<?php echo $data['manager']->email_address; ?>" disabled>
                  ...
                  <div class="row">
                      <p>
                          ...
                          <input type="date" id="dob" name="date_of_birth" value="<?php echo $data['manager']->date_of_birth; ?>" disabled>
                      ...
                      <p>
                          ...
                          <input type="number" id="contact" name="contact_number" value="<?php echo $data['manager']->contact_number; ?>" disabled>
                  ...
                  <p>
                      ...
                      <input type="text" id="address" name="home_address" value="<?php echo $data['manager']->home_address; ?>" disabled>
                  ...
                  <p>
                      ...
                      <input type="number" id="NIC" name="NIC_no" value="<?php echo $data['manager']->NIC_no; ?>" disabled>
    ...
    <script>
        ...
        function cacheOriginalValues() {
          inputs.forEach(input => {
            if (input.type !== 'file' && input.name !== 'manager_id') {
