    ...
    <main>
      ...
      <div class="table-container">
          ...
          <div class="user-table-header">
            ...
            <button class="add-user-btn" onclick="window.location.href='<?php echo URLROOT; ?>/manager/admins/createAdmin'">+ Add Admin</button>
          </div>
              ...
              <tbody>
                  <?php if (!empty($data['admins'])): ?>
                    <?php foreach ($data['admins'] as $admin) : ?>
                      <tr onclick="window.location.href='<?php echo URLROOT; ?>/manager/admins/viewAdmin?id=<?php echo $admin->admin_id; ?>';" style="cursor: pointer;">
