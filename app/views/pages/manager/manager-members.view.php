    ...
    <main>
      ...
      <div class="table-container">
          ...
          <div class="user-table-header">
            ...
            <button class="add-user-btn" onclick="window.location.href='<?php echo URLROOT; ?>/manager/members/createMember'">+ Add Member</button>
          </div>
          ...
          <div class="user-table-wrapper">
            <table class='user-table'>
              ...
              <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="13" style="text-align: center;">N members available</td>
                    </tr>
                <?php endif; ?>
              </tbody>
            </table>
