  ...
  <body>
    ...
    <script>    
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('userDetailsLink').href = `<?php echo URLROOT; ?>/manager/admins/viewManager?id=${managerId}`;
            document.getElementById('salaryHistoryLink').href = `<?php echo URLROOT; ?>/manager/admins/salaryHistory?id=${managerId}`;
            } else {
            ...
            salaryForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    const response = await fetch(`<?php echo URLROOT; ?>/AdminSalary/addAdminSalaryPayment`, {
                        method: 'POST',
                        headers: {
            ...
            async function loadSalaryHistory() {
              try {
                  const response = await fetch(`<?php echo URLROOT; ?>/AdminSalary/salaryHistory?id=${adminId}`);
                  ...
                  deleteButtons.forEach(button => {
                      button.addEventListener('click', async (e) => {
                          ...
                          if (confirm('Are you sure you want to delete this salary payment?')) {
                              try {
                                  const response = await fetch(`<?php echo URLROOT; ?>/AdminSalary/deleteAdminSalaryPayment`, {
                                      method: 'POST',
                                      headers: {
                                          'Content-Type': 'application/x-www-form-urlencoded',
                                      },
