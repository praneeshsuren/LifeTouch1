...
<html lang="en">
        ...
        <div class="user-container">
          ...
          <form id="userForm" method="POST" enctype="multipart/form-data" action="<?php echo URLROOT; ?>/user/admin/updateAdmin">
            ...
            <div class="action-buttons">
              ...
              <button type="button" id="deleteBtn" class="delete-btn" onclick="window.location.href='<?php echo URLROOT; ?>/manager/admins/deleteAdmin?id=<?php echo $data['admin']->admin_id; ?>';">Delete</button>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (adminId) {
      document.getElementById('userDetailsLink').href = `<?php echo URLROOT; ?>/manager/admins/viewAdmin?id=${adminId}`;
      document.getElementById('salaryHistoryLink').href = `<?php echo URLROOT; ?>/manager/admins/salaryHistory?id=${adminId}`;
    } else {
