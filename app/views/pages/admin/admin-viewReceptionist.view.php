      ...
      <div class="navbar-container">
        <div class="navbar">
          <ul class="nav-links">
            ...
            <li><a href="#membership-details">Receptionist Attendance</a></li>
            <div class="separator"></div>
            <li><a href="#supplement-records">Salary History</a></li>
            <div class="separator"></div>
            <li><a href="#workout-schedules">Receptionist Calendar</a></li>
          </ul>
        </div>
      </div>
      <div class="user-details">
      <form id="userForm" method="POST" enctype="multipart/form-data" action="<?php echo URLROOT; ?>/admin/receptionists/updateReceptionist">
          <div class="details">
