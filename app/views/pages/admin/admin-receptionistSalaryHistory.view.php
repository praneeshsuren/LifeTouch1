        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            salaryForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    const response = await fetch(`<?php echo URLROOT; ?>/ReceptionistSalary/addReceptionistSalaryPayment`, {
                        method: 'POST',
                        headers: {
            ...
            async function loadSalaryHistory() {
              try {
                  const response = await fetch(`<?php echo URLROOT; ?>/ReceptionistSalary/salaryHistory?id=${receptionistId}`);
                  ...
                  deleteButtons.forEach(button => {
                      button.addEventListener('click', async (e) => {
                          ...
                          if (confirm('Are you sure you want to delete this salary payment?')) {
                              try {
                                  const response = await fetch(`<?php echo URLROOT; ?>/ReceptionistSalary/deleteReceptionistSalaryPayment`, {
                                      method: 'POST',
                                      headers: {
                                          'Content-Type': 'application/x-www-form-urlencoded',
                                      },
