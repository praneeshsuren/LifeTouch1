  ...
  <body>
    ...
    <div class="details">
        ...
        <div class="profile-picture">
            <img src="<?php echo URLROOT; ?>/assets/images/Member/<?php echo !empty($data['admin']->image) ? $data['admin']->image : 'default-placeholder.jpg'; ?>" alt="Profile Picture" id="userImage">
        ...
        <div class="user-details">
            ...
            <p>
                ...
                <a href="<?php echo URLROOT; ?>/admin/changePassword" class="change-password-link">Click here to change password</a>
            </p>
            <p>
