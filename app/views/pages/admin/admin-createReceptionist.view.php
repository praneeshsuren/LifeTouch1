  ...
  <body>
    ...
    <main>
      ...
      <div class="user-form">
        ...
        <form action="<?php echo URLROOT; ?>/admin/receptionists/registerReceptionist" method="post">
            <div class="form-container">
                ...
                <div class="right-column">
                    ...
                    <div class="input-image-box">
                        <label for="user-image">Upload Receptionist Image</label>
                        <div class="image-container">
                            <img id="profile-image" src="<?php echo URLROOT; ?>/assets/images/no_img.jpg" alt="Receptionist Image">
                        </div>
                        <input
                            type="file"
            ...
            <div class="btn-container">
                <button type="submit" class="user-create-btn">Create receptionist</button>
            </div>
        </form>
    </div>
