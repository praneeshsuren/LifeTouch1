...
<form action="<?php echo URLROOT; ?>/receptionist/trainers/registerTrainer" method="post">
    <div class="input-container">
        ...
        <div class="input-box">
            <input type="email" id="email" name="email" placeholder="Email Address" value="<?php echo $_POST['email'] ?? ''; ?>" required>
        ...
        <div class="input-box">
            <input type="text" id="address" name="address" placeholder="Address" value="<?php echo $_POST['address'] ?? ''; ?>" required>
            <?php if (!empty($data['errors']['address'])): ?>
                <span class="invalid-feedback"><?php echo $data['errors']['address']; ?></span>
            <?php endif; ?>
        </div>
